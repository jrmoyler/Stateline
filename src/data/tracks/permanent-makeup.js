...
// verified:true and the note says plainly what is and is not established. Do not upgrade an
...
export default {
  ...
  AL: {vendor:"Alabama Dept. of Public Health — Division of Food, Milk and Lodging (body art program)", questions:"—", time:"—", pass:"—", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory (names ADPH Division of Food, Milk and Lodging); AMA Academy 2026 state compilation", verified:true},
  ...
  AK: {vendor:"Alaska Board of Barbers and Hairdressers (Dept. of Commerce, Community & Economic Development)", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory; AMA Academy 2026 state compilation (~250 hours)", verified:true},
  ...
  AZ: {vendor:"NO state licence — county health departments only (Arizona Barbering & Cosmetology Board does NOT license permanent makeup)", questions:"—", time:"—", pass:"—", fee:"varies by county",
       ...
       source:"Arizona Barbering & Cosmetology Board (bcb.az.gov) scope; American Academy of Micropigmentation state directory ('no state-level regulations; check local jurisdictions'); AMA Academy 2026 compilation", verified:true},
  ...
  AR: {vendor:"Arkansas Dept. of Health — Body Art Program", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory; AMA Academy 2026 state compilation", verified:true},
  ...
  CO: {vendor:"Colorado Dept. of Regulatory Agencies (DORA) — Office of Barber and Cosmetology; facilities also under CDPHE body art rules", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"DORA Office of Barber and Cosmetology (dpo.colorado.gov/BarberCosmetology) named as regulator; 132-hour prerequisite reported by multiple DORA-approved training providers and the AMA Academy 2026 compilation", verified:true,
  ...
  DE: {vendor:"Delaware Division of Public Health — body art ESTABLISHMENT licensing", questions:"—", time:"—", pass:"—", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory ('Body Art Establishments (not Artists)'); AMA Academy 2026 compilation", verified:true},
  ...
  DC: {vendor:"CONFLICTING — DC Health body art establishment/operator licensing vs. the DC Board of Barber and Cosmetology", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory vs. AMA Academy 2026 compilation — the two contradict each other; no dc.gov confirmation obtained", verified:true},
  ...
  ID: {vendor:"NO state licence — Idaho regulates body art on MINORS only; local public health districts otherwise", questions:"—", time:"—", pass:"—", fee:"varies by health district",
       ...
       source:"American Academy of Micropigmentation state directory (Dept. of Health and Welfare, Licensing & Certification); AMA Academy 2026 compilation ('none at state level')", verified:true},
  ...
  IN: {vendor:"COUNTY health departments, under Indiana state body art rules (410 IAC 1-5)", questions:"—", time:"—", pass:"—", fee:"varies by county",
       ...
       source:"American Academy of Micropigmentation state directory (Indiana State Dept. of Public Health); AMA Academy 2026 compilation ('local body-art permit')", verified:true},
  ...
  KY: {vendor:"LOCAL health departments, under the Kentucky Cabinet for Health and Family Services (902 KAR 45:065)", questions:"—", time:"—", pass:"—", fee:"varies by local health department",
       ...
       source:"American Academy of Micropigmentation state directory (Cabinet for Health and Family Services working with the county board of health); AMA Academy 2026 compilation", verified:true},
  ...
  LA: {vendor:"Louisiana Dept. of Health — commercial body art OPERATOR permit plus FACILITY permit (LAC Title 51, Part XXVIII)", questions:"—", time:"—", pass:"—", fee:"unconfirmed",
       ...
       source:"Louisiana Dept. of Health, Commercial Body Art programme (ldh.la.gov/page/commercial-body-art) as reported in search results; LAC Title 51 Part XXVIII; La. R.S. Title 40 Chapter 33", verified:true,
  ...
  ME: {vendor:"Maine Dept. of Health and Human Services — Health Inspection Program (tattoo artist and micropigmentation practitioner licences)", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory (Division of Environmental and Community Health); AMA Academy 2026 compilation ('practitioner license')", verified:true},
  ...
  MA: {vendor:"LOCAL boards of health, under the Massachusetts model body art regulations (105 CMR 300.000 framework)", questions:"—", time:"—", pass:"—", fee:"set by each municipality",
       ...
       source:"American Academy of Micropigmentation state directory (Massachusetts Dept. of Public Health, local board of health administration); AMA Academy 2026 compilation", verified:true},
  ...
  MS: {vendor:"Mississippi State Dept. of Health — tattoo artist licence", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory; AMA Academy 2026 compilation (~9 months apprenticeship)", verified:true},
  ...
  MO: {vendor:"Missouri Division of Professional Registration — Office of Tattooing, Body Piercing and Branding (20 CSR 2267)", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"Missouri Code of State Regulations Title 20 Division 2267 (Office of Tattooing, Body Piercing and Branding); AMA Academy 2026 compilation (~300 hours)", verified:true},
  ...
  MT: {vendor:"Montana Dept. of Public Health and Human Services with local health departments — body art licence", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory; AMA Academy 2026 compilation ('county (MT DPHHS)')", verified:true},
  ...
  NV: {vendor:"COUNTY health authorities — Southern Nevada Health District (Clark County) and Washoe County Health District; no statewide Nevada licence", questions:"—", time:"—", pass:"—", fee:"varies by health district",
       ...
       source:"Southern Nevada Health District Body Art programme (southernnevadahealthdistrict.org); American Academy of Micropigmentation state directory (Division of Public and Behavioral Health plus SNHD)", verified:true,
  ...
  NH: {vendor:"New Hampshire Office of Professional Licensure and Certification — body art practitioner licensure", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory ('apprentice with a licensed Artist for at least three years') vs. AMA Academy 2026 compilation ('microblading certificate; accredited course') — the two contradict each other", verified:true},
  ...
  NJ: {vendor:"LOCAL health departments, under New Jersey Dept. of Health body art rules (N.J.A.C. 8:27)", questions:"—", time:"—", pass:"—", fee:"varies by municipality",
       ...
       source:"American Academy of Micropigmentation state directory (NJ Dept. of Health); AMA Academy 2026 compilation ('local health department; 40+ hours PMU training')", verified:true},
  ...
  NC: {vendor:"COUNTY health departments, under N.C.G.S. 130A-283 — tattoo artist permit", questions:"—", time:"—", pass:"—", fee:"state-set annual permit fee — commonly reported as $250; confirm with your county",
       ...
       source:"American Academy of Micropigmentation state directory (NC Dept. of Health and Human Services); AMA Academy 2026 compilation", verified:true},
  ...
  ND: {vendor:"CONFLICTING — North Dakota Health and Human Services vs. no state-level regulation", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory vs. AMA Academy 2026 compilation — the two contradict each other; no nd.gov confirmation obtained", verified:true},
  ...
  OK: {vendor:"Oklahoma State Dept. of Health — tattoo/body piercing artist and facility licensing (63 O.S. §1-1530)", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory; AMA Academy 2026 compilation ('PMU specialist license')", verified:true},
  ...
  RI: {vendor:"Rhode Island Dept. of Health — body art practitioner licence AND establishment licence", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory ('license for Tattoo Artist and also for Tattoo Parlor'); AMA Academy 2026 compilation", verified:true},
  ...
  SD: {vendor:"South Dakota Dept. of Health with local authorities — minimal state-level body art regulation", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory (SD Dept. of Health); AMA Academy 2026 compilation ('minimal state regulation')", verified:true},
  ...
  TN: {vendor:"Tennessee Dept. of Health — tattoo artist licence and tattoo studio licence (T.C.A. Title 62, Ch. 38)", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory ('artist + establishment license'); AMA Academy 2026 compilation", verified:true},
  ...
  UT: {vendor:"LOCAL health departments (e.g. Salt Lake County Health Dept.) — no statewide Utah practitioner licence", questions:"—", time:"—", pass:"—", fee:"varies by local health department",
       ...
       source:"American Academy of Micropigmentation state directory (Utah Dept. of Health); AMA Academy 2026 compilation ('county; largely unregulated at state level')", verified:true},
  ...
  VT: {vendor:"Vermont Office of Professional Regulation (Secretary of State) — tattooist and body piercer licensure", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory ('Secretary of the State; 60 hour minimum training at a state approved training course'); AMA Academy 2026 compilation", verified:true},
  ...
  WV: {vendor:"West Virginia Dept. of Health — Office of Environmental Health Services (tattoo studio and artist permits, W. Va. Code §16-38)", questions:"unconfirmed", time:"unconfirmed", pass:"unconfirmed", fee:"unconfirmed",
       ...
       source:"American Academy of Micropigmentation state directory (WV Dept. of Health and Human Resources); AMA Academy 2026 compilation", verified:true},
  ...
  WY: {vendor:"NO state licence — local authorities only", questions:"—", time:"—", pass:"—", fee:"varies locally",
       ...
       source:"American Academy of Micropigmentation state directory (Wyoming Dept. of Health); AMA Academy 2026 compilation ('none at state level')", verified:true},
  },
